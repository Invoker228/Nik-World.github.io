...
$tableSchema[] = "CREATE TABLE IF NOT EXISTS " . PREFIX . "_post_extras (
  ...
  KEY `user_id` (`user_id`)
	...
	if ( $error_info ) {
		...
		msgbox("info","Информация", "<form action=\"index.php\" method=\"GET\">{$error_info}<br />{$sql_info}<br /><br />Нажмите далее для продолжения процессa обновления скрипта<br /><br /><input type=\"hidden\" name=\"next\" value=\"step1\"><input class=\"btn btn-success\" type=\"submit\" value=\"Далее ...\"></form>");

	} else {

	    msgbox("info","Информация", "<form action=\"index.php\" method=\"GET\"><br /><br /><div style=\"border: 1px solid #475936; background: #6F8F52; color: #FFFFFF;padding:8px;text-align: justify;\">Было успешно выполнено <b>5 MySQL</b> запросов.</div><br /><br />{$sql_info}<br /><br />Нажмите далее для продолжения процессa обновления скрипта<br /><br /><input type=\"hidden\" name=\"next\" value=\"step1\"><input class=\"btn btn-success\" type=\"submit\" value=\"Далее ...\"></form>");
...
if( $_SESSION['step_update'] == 1 ) {
	...
	if ( $error_info ) {
		...
		msgbox("info","Информация", "<form action=\"index.php\" method=\"GET\">{$error_info}<br />{$sql_info}<br /><br />Нажмите далее для продолжения процессa обновления скрипта<br /><br /><input type=\"hidden\" name=\"next\" value=\"step2\"><input class=\"btn btn-success\" type=\"submit\" value=\"Далее ...\"></form>");

	} else {

	    msgbox("info","Информация", "<form action=\"index.php\" method=\"GET\"><br /><br /><div style=\"border: 1px solid #475936; background: #6F8F52; color: #FFFFFF;padding:8px;text-align: justify;\">Был успешно выполнен <b>1 MySQL</b> запрос.</div><br /><br />{$sql_info}<br /><br />Нажмите далее для продолжения процессa обновления скрипта<br /><br /><input type=\"hidden\" name=\"next\" value=\"step2\"><input class=\"btn btn-success\" type=\"submit\" value=\"Далее ...\"></form>");
...
if( $_SESSION['step_update'] == 2 ) {
	...
	if ( $error_info ) {
		...
		msgbox("info","Информация", "<form action=\"index.php\" method=\"GET\">{$error_info}<br />{$sql_info}<br /><br />Нажмите далее для продолжения процессa обновления скрипта<br /><br /><input type=\"hidden\" name=\"next\" value=\"step3\"><input class=\"btn btn-success\" type=\"submit\" value=\"Далее ...\"></form>");

	} else {

	    msgbox("info","Информация", "<form action=\"index.php\" method=\"GET\"><br /><br /><div style=\"border: 1px solid #475936; background: #6F8F52; color: #FFFFFF;padding:8px;text-align: justify;\">Был успешно выполнен <b>1 MySQL</b> запрос.</div><br /><br />{$sql_info}<br /><br />Нажмите далее для продолжения процессa обновления скрипта<br /><br /><input type=\"hidden\" name=\"next\" value=\"step3\"><input class=\"btn btn-success\" type=\"submit\" value=\"Далее ...\"></form>");
...
if( $_SESSION['step_update'] == 3 ) {
	...
	if ( $error_info ) {
		...
		msgbox("info","Информация", "<form action=\"index.php\" method=\"GET\">{$error_info}<br />{$sql_info}<br /><br />Нажмите далее для продолжения процессa обновления скрипта<br /><br /><input type=\"hidden\" name=\"next\" value=\"step4\"><input class=\"btn btn-success\" type=\"submit\" value=\"Далее ...\"></form>");

	} else {

	    msgbox("info","Информация", "<form action=\"index.php\" method=\"GET\"><br /><br /><div style=\"border: 1px solid #475936; background: #6F8F52; color: #FFFFFF;padding:8px;text-align: justify;\">Был успешно выполнен <b>1 MySQL</b> запрос.</div><br /><br />{$sql_info}<br /><br />Нажмите далее для продолжения процессa обновления скрипта<br /><br /><input type=\"hidden\" name=\"next\" value=\"step4\"><input class=\"btn btn-success\" type=\"submit\" value=\"Далее ...\"></form>");
...
if( $_SESSION['step_update'] == 4 ) {
	...
	if ( $error_info ) {
		...
		msgbox("info","Информация", "<form action=\"index.php\" method=\"GET\">{$error_info}<br />{$sql_info}<br /><br />Нажмите далее для продолжения процессa обновления скрипта<br /><br /><input type=\"hidden\" name=\"next\" value=\"step5\"><input class=\"btn btn-success\" type=\"submit\" value=\"Далее ...\"></form>");

	} else {

	    msgbox("info","Информация", "<form action=\"index.php\" method=\"GET\"><br /><br /><div style=\"border: 1px solid #475936; background: #6F8F52; color: #FFFFFF;padding:8px;text-align: justify;\">Был успешно выполнено <b>3 MySQL</b> запроса.</div><br /><br />{$sql_info}<br /><br />Нажмите далее для продолжения процессa обновления скрипта<br /><br /><input type=\"hidden\" name=\"next\" value=\"step5\"><input class=\"btn btn-success\" type=\"submit\" value=\"Далее ...\"></form>");
...
if( $_SESSION['step_update'] == 5 ) {
	...
	msgbox("info","Информация", "<form action=\"index.php\" method=\"GET\">Обновление базы данных с версии <b>9.5</b> до версии <b>9.6</b> успешно завершено.<br /><br />Нажмите далее для продолжения процессa обновления скрипта<br /><br /><input type=\"hidden\" name=\"next\" value=\"96\"><input class=\"btn btn-success\" type=\"submit\" value=\"Далее ...\"></form>");
